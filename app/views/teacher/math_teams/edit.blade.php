...
@include('students.partial.js', [ 'type' => 'math_teams' ])

@section('main')
{{ Form::model($math_team, array('method' => 'PATCH', 'route' => array('teacher.math_teams.update', $math_team->id), 'role'=>"form", 'class' => 'col-md-8')) }}
