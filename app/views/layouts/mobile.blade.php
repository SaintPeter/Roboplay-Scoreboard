...
<html>
	...
	<body>
		<div data-role="page" data-url="/scoreboard/score/">

			<div data-role="header">
				<h1>@yield('header')</h1>
				<a href="/scoreboard" class="ui-btn-left" data-icon="home" data-ajax="false" data-iconpos="notext" data-direction="reverse">Home</a>
				@yield('navbar')
			</div><!-- /header -->
