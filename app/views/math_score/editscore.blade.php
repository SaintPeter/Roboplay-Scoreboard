...
{{ Form::open( [ 'route' => [ 'math_score.update', $score->id ], 'method' => 'post', 'id' => 'math_form', 'data-ajax' => 'false' ] ) }}
	<ul data-role="listview">
		<li class="ui-field-contain ui-li-static ui-body-inherit ui-first-child" data-type="vertical">
		<p>Score</p>
		<input class="ui-clear-both" name="score" min="0" max="{{ $challenge->points }}" step="1" value="{{ $score->score }}" type="range">
		</li>
		<li>
...
<script>
	$("#back_button").attr("href", "{{ route('display.mathteamscore', [ $team->id] ) }}");
</script>
